...
$from_email = "info@bipsonline.com";
...
<tr><td>Email</td><td><input type="text" size="30" name="email"></td></tr>
<tr><td valign="top">Comments</td><td><textarea name="comments" rows="6" cols="30"></textarea></td></tr>
<tr><td valign="top">Security code</td><td><img id="captcha" src="/securimage/securimage_show.php" alt="CAPTCHA Image"><br><a href="#" style="background:#ececec" onclick="document.getElementById('captcha').src = '/securimage/securimage_show.php?' + Math.random(); return false">Reload Image</a></td></tr>
<tr><td>Verify code</td><td><input type="text" name="captcha_code" size="10" maxlength="6"></td></tr>
<tr><td>&nbsp;</td><td><input type="submit" value="Send"></td></tr>
</table>
</form>
...
$field_order_keys = array('first_name','last_name','phone','email','street_address','city','state','zip','comments','questions');
